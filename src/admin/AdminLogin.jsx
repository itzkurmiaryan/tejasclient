  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black text-white">
      ...
      <motion.form
        ...
        className="relative z-10 backdrop-blur-2xl bg-white/5 border border-white/10 shadow-2xl rounded-3xl p-10 w-[360px]"
      >

        {/* 🔥 ELECTRIC BORDER */}
        <div className="absolute inset-0 rounded-3xl border border-transparent hover:border-orange-500/50 transition duration-500 pointer-events-none"></div>
